...
const dsl = {
  "nodes":[
    ...
    {"id":"llm-2","type":"llmNode","data":{"label":"LLM","model":"gpt-3.5","inputs":[{"name":"prompt_llm","from":"input-1.prompt"},{"name":"system_llm","from":"input-1.system"}],"outputs":[{"name":"content","type":"string"}]}}
  ],
  "edges":[
